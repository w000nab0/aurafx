...
def test_open_and_reverse_position():
    manager = PositionManager(pip_size=0.001, lot_size=100, stop_loss_pips=20, take_profit_pips=40)
...
def test_stop_loss_trigger():
    manager = PositionManager(pip_size=0.001, lot_size=100, stop_loss_pips=10, take_profit_pips=20)
